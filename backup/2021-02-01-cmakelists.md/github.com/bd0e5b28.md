[t1](/carl-wang-cn/demo/tree/master/cmake/t1 "t1")

[Symptom: 增加cmake示例](/carl-wang-
cn/demo/commit/3bfa8579d16a9c3463aeeaa641f530c008683121 "Symptom: 增加cmake示例
...
[t2](/carl-wang-cn/demo/tree/master/cmake/t2 "t2")
...
[t3](/carl-wang-cn/demo/tree/master/cmake/t3 "t3")

[笔误](/carl-wang-cn/demo/commit/d3cc8493fdb9dec8d73cd9bfb4e125791636e16d "笔误")

6 years ago

[t4](/carl-wang-cn/demo/tree/master/cmake/t4 "t4")
...
[t5](/carl-wang-cn/demo/tree/master/cmake/t5 "t5")
...
[t6](/carl-wang-cn/demo/tree/master/cmake/t6 "t6")
...
[README.md](/carl-wang-cn/demo/blob/master/cmake/README.md "README.md")

[adjust readme](/carl-wang-
cn/demo/commit/c71790fc09f5867a04db8504acd0affc82e1a656 "adjust readme")
...
IF (expression), expression不为：空,0,N,NO,OFF,FALSE,NOTFOUND或<var>_NOTFOUND,为真 IF
(not exp), 与上面相反 IF (var1 AND var2) IF (var1 OR var2) IF (COMMAND cmd)
如果cmd确实是命令并可调用,为真 IF (EXISTS dir) IF (EXISTS file) 如果目录或文件存在,为真 IF (file1
IS_NEWER_THAN file2),当file1比file2新,或file1/file2中有一个不存在时为真,文件名需使用全路径 IF
(IS_DIRECTORY dir) 当dir是目录时,为真 IF (DEFINED var) 如果变量被定义,为真 IF (var MATCHES
regex) 此处var可以用var名,也可以用${var} IF (string MATCHES regex)
...
**数字比较表达式** IF (variable LESS number) IF (string LESS number) IF (variable
GREATER number) IF (string GREATER number) IF (variable EQUAL number) IF
(string EQUAL number)

**按照字母表顺序进行比较** IF (variable STRLESS string) IF (string STRLESS string) IF
(variable STRGREATER string) IF (string STRGREATER string) IF (variable
STREQUAL string) IF (string STREQUAL string)
...
示例：
    ...
    2. 范围 FOREACH(loop_var RANGE total) COMMAND1(ARGS ...) COMMAND2(ARGS ...) ... ENDFOREACH(loop_var)
...
####cmake中如何使用动态库和静态库（查找库的路径） 参考INCLUDE_DIRECTORIES, LINK_DIRECTORIES,
TARGET_LINK_LIBRARIES用法 t4示例使用动态库或静态库
t5示例如何使用cmake预定义的cmake模块(以FindCURL.cmake为例演示)
t6示例如何使用自定义的cmake模块(编写了自定义的FindHELLO.cmake) **注意**
读t5和t6的CMakeLists.txt和FindHELLO.cmake中的注释部分
...
####cmake中如何增加编译选项 使用变量CMAKE_C_FLAGS添加C编译选项 使用变量CMAKE_CXX_FLAGS添加C++编译选项
使用ADD_DEFINITION添加
...
**建议** ：在Project根目录先建立build,然后在build文件夹内运行cmake ..，这样就不会污染源代码,
如果不想要这些自动生成的文件了，只要简单的删除build文件夹就可以

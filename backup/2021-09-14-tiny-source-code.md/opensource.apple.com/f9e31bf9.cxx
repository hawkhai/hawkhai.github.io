<html xmlns="http://www.w3.org/1999/xhtml"><head><meta name="color-scheme" content="light dark" /></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">//===-------------------------- cxa_guard.cxx -----------------------------===//
//

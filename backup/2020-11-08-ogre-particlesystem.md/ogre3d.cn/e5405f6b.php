<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="zh"><head>
  <meta charset="utf-8" />
  <meta name="theme-color" content="#fff" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0,&#10;                                 maximum-scale=1.0, user-scalable=no" />
  <title>ogre3d.cn</title>
...
<body id="t" style="font-family: 'Segoe UI',Arial,'Microsoft Yahei',sans-serif; font-size: 75%" jstcache="0" class="neterror">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        ...
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2">找不到 <strong jscontent="hostName" jstcache="23">ogre3d.cn</strong> 的服务器 IP 地址。</p>
              ...
              <div id="error-information-popup-content" jstcache="0">
                <div id="suggestions-list" style="" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="17">
                  ...
                  <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? 'single-suggestion' : ''" jstcache="20" class="">
                    <li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="22" jsinstance="0">检查网络连接</li><li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="22" jsinstance="1"><a href="#buttons" onclick="toggleHelpBox()" jstcache="0">检查代理服务器、防火墙和 DNS 配置</a></li><li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="22" jsinstance="*2"><a href="javascript:diagnoseErrors()" id="diagnose-link" jstcache="0">运行 Windows 网络诊断</a></li>
                  </ul>
                </div>
    ...
    <div id="buttons" class="nav-wrapper suggested-left" jstcache="0">
      <div id="control-buttons" jstcache="0">
        <button id="reload-button" class="blue-button text-button" onclick="reloadButtonClick(this.url);" jsselect="reloadButton" jsvalues=".url:reloadUrl" jscontent="msg" jstcache="6">重新加载</button>
      ...
      <button id="details-button" class="secondary-button text-button small-link" onclick="detailsButtonClick(); toggleHelpBox()" jscontent="details" jsdisplay="(suggestionsDetails &amp;&amp; suggestionsDetails.length &gt; 0) || diagnose" jsvalues=".detailsText:details; .hideDetailsText:hideDetails;" jstcache="3" style="">详细信息</button>
    </div>
    <div id="details" class="hidden" jstcache="0">
      ...
      </div><div class="suggestions" jsselect="suggestionsDetails" jstcache="4" jsinstance="1" style="">
      ...
      </div><div class="suggestions" jsselect="suggestionsDetails" jstcache="4" jsinstance="2" style="">
      ...
      </div><div class="suggestions" jsselect="suggestionsDetails" jstcache="4" jsinstance="3" style="">
      ...
      </div><div class="suggestions" jsselect="suggestionsDetails" jstcache="4" jsinstance="*4" style="">
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2">找不到 <strong jscontent="hostName" jstcache="23">ogre3d.cn</strong> 的服务器 IP 地址。</div>
  </div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"详细信息","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"'Segoe UI',Arial,'Microsoft Yahei',sans-serif","fontsize":"75%","heading":{"hostName":"ogre3d.cn","msg":"无法访问此网站"},"hideDetails":"隐藏详细信息","iconClass":"icon-generic","language":"zh","reloadButton":{"msg":"重新加载","reloadUrl":"http://ogre3d.cn/wiki/index.php?title=%E6%96%87%E6%A1%A3:%E6%89%8B%E5%86%8C:1-4-0:3.3.1_%E7%B2%92%E5%AD%90%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7%22%20%5Cl%20%22billboard_type%22%20%5Co%20%22%E6%96%87%E6%A1%A3:%E6%89%8B%E5%86%8C:1-4-0:3.3.1%20%E7%B2%92%E5%AD%90%E7%B3%BB%E7%BB%9F%E5%B1%9E%E6%80%A7"},"suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\"&gt;尝试运行 Windows 网络诊断\u003C/a&gt;。"}],"summary":{"failedUrl":"http://ogre3d.cn/wiki/index.php?title=文档:手册:1-4-0:3.3.1_粒子系统属性\"%20%5Cl%20\"billboard_type\"%20%5Co%20\"文档:手册:1-4-0:3.3.1%20粒子系统属性","hostName":"ogre3d.cn","msg":"无法找到 \u003Cstrong jscontent=\"hostName\"&gt;\u003C/strong&gt; 的 \u003Cabbr id=\"dnsDefinition\"&gt;DNS 地址\u003C/abbr&gt;。正在诊断该问题。"},"textdirection":"ltr","title":"ogre3d.cn"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

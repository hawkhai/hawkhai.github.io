...
* [windows api 设计的如何？C 语言怎么从函数中返回未知长度的字符串，可以让它的调用者优雅地接收？ {% include relref_svgzhihu.html %}](https://www.zhihu.com/question/33058061)
* [C 接口中的内存分配释放 {% include relref_svgzhihu.html %}](https://zhuanlan.zhihu.com/p/95299255)

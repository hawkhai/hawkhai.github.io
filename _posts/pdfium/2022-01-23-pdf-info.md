...
第一行，1 为对象号，来唯一标识一个对象，“0”为产生号，记录创建后的修改次数，obj 对象包含在”<<”和“>>”中，以 endobj 结尾，Catalog 表明这是一个根对象，“/Pages 3 0 R”表示 pages 的目标对象号为 3 的对象，“3 0 R”表示对对象 3 的引用。
...
* `/Root` 说明根对象的对象号
* `/Info` 指定文档信息字典的参考对象
* `/ID` 指定由两个未加密字节串组成的数组，这些字节串构成文件标识符

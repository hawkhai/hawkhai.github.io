...
$$
f(0)=2,\quad f(1)=3,\quad f(2)=4,\quad f(3)=4
$$

写成序列形式：

$$
f[n] = [,2,;3,;4,;4,],\quad n=0,1,2,3
$$
...
$$
F(k) = \sum_{n=0}^{3} f(n), e^{-j\frac{2\pi}{4}kn},
\quad k = 0,1,2,3
$$
...
> 对序列 (f=[2,3,4,4]) 进行 4 点 DFT，可得
> $$
> F(0)=13,\quad F(1)=-2+j,\quad F(2)=-1,\quad F(3)=-2-j
> $$
> 其中 (F(0)) 为直流分量，其余为不同离散频率的复幅值。

...
$$reflect$$ 函数用来计算反射向量，GLSL 中参数是入射方向和法线方向：$$reflect(I, N)$$。
...
以上便是当 $$L$$ 表示从片段指向光源的方向时，反射方向 $$r$$ 的运算公式；GLSL 的 $$reflect(I, N)$$ 使用的是入射方向 $$I$$，公式为 $$I - 2 · dot(N,I) · N$$，所以代码里常写成 $$reflect(-L, N)$$。

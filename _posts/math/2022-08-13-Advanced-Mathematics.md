...
每天睡觉前，学习一小时，日拱一卒 功不唐捐，76 小时的视频，看了三个月。
...
1. 极值，领域内，最小（大），不唯一。
2. 最值，整个区域内，最小（大）；最值的数值唯一，但取得最值的点不一定唯一。
...
在二维空间中，常用标量 $a_x b_y-a_y b_x$ 表示对应的有向面积；其绝对值等于由向量 $a$ 和向量 $b$ 构成的平行四边形面积。
...
{% include image.html url="/assets/images/220813-advanced-mathematics/20230822224151.png" %}
...
{% include image.html url="/assets/images/220813-advanced-mathematics/20230822233443.png" %}

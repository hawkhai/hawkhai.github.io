...
def main(dataset):
    classes = {
        ...
        "cartoon": ["anime", "cartoon", "animated series", "comic", "manga", "illustration", "animated character"],
        "building": ["building", "architecture", "urban elements", "skyscraper", "structure", "historical building", "office building"],
        "food": ["food", "dish", "meal", "cuisine", "snack", "ingredient", "beverage", "dessert"],
        "goods": ["goods", "everyday objects", "products", "merchandise", "items", "commodities", "retail items"],
        "nightscape": ["nightscape", "night view", "night scene", "city lights", "starlight", "nighttime", "nocturnal"],
        "people": ["people", "person", "portrait", "individual", "group", "human", "figure"],
        "plant": ["plant", "flower", "tree", "shrub", "leaf", "vegetation", "herb", "bush"],

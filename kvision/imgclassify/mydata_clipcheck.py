...
def main(dataset):
    classes = {
        ...
        "cartoon": ["anime", "cartoon", "animated series", "comic", "manga"],
        "building": ["building", "architecture", "urban elements", "skyscraper", "historical building", "office building"],
        "food": ["food", "dish", "meal", "cuisine", "snack", "beverage", "dessert"],
        "goods": ["goods", "everyday objects", "products", "merchandise", "commodities", "retail items"],
        "nightscape": ["nightscape", "night view", "night scene", "city lights", "starlight"],
        "people": ["people", "person", "portrait", "human"],
        "plant": ["plant", "flower", "tree", "shrub", "leaf", "vegetation", "bush"],
        "landscape": ["scenery", "natural landscape", "outdoor", "nature", "countryside"],
        "text": ["text", "scanned document", "written content", "document", "manuscript"],
    ...
    classes_cn = {
        ...
        "cartoon": ["动漫", "卡通", "动画", "漫画", "插画"],
        "building": ["建筑", "建筑物", "摩天大楼", "城市建筑", "历史建筑", "办公楼"],
        "food": ["食物", "菜肴", "餐点", "美食", "小吃", "饮品", "餐饮"],
        "goods": ["商品", "日常物品", "货物", "物品", "家庭用品"],
        "nightscape": ["夜景", "夜晚风光", "城市夜景", "星空"],
        "people": ["人物", "人", "肖像", "人像"],
        "plant": ["植物", "花卉", "树木", "灌木", "叶子", "绿植", "灌木丛"],
        "landscape": ["风景", "自然景观", "户外风光", "自然环境", "乡村风光"],
        "text": ["文本", "扫描件", "书写内容", "文档", "手稿",],
        "vehicle": ["车辆", "交通工具", "汽车", "自行车", "公交车", "火车", "飞机", "船舶", "摩托车"],

...
**模型可以组合出训练集中没有逐字出现过的表达和方案，但生成内容仍强烈受训练语料、反馈数据和推理上下文约束；如果某些内容反复出现，它们大概率就会被模型视为“合理存在”的内容。**

人类与 AI 的关系，类似于人类与小麦的关系，是一种双向驯化的过程。
人类通过设计和优化不断改进 AI，而 AI 也深刻地影响着人类的行为模式与社会结构。最终，这种共生与进化的关系，塑造了彼此的未来发展。
​主流大语言模型大多仍以自回归生成为核心，但这肯定不是最终形态；通常部署时参数不会在每次推理中实时更新，和人脑在活动中持续改变连接强度并不是一回事。
...
2. 中美都想登月，美国 Artemis 仍依赖 SLS 这种超重型火箭。乖乖，这种路线好费钱的。当年为什么要弄土星 5 呢，
    ...
    走老路的 SLS，被波音拖成这熊样；NASA 后来已把 Artemis III 调整为 2027 年近地轨道载人演示任务，首次载人登月目标顺延到 Artemis IV 的 2028 年。
...
《庞涓夜走马陵道》“学成文武艺，货与帝王家。”业余时间，专心练剑。
大学只有四年，而我们工作却有几十年，是一个漫长的季节，在这个时间里，合理规划学习路线就显得很重要。
...
人类生育率 2.1 大致是世代更替水平；在存在不婚、不育、丁克和夭折等情况时，需要有相当一部分家庭生育二胎以上，现实压力会被显著推高。
